...
export const STYLES_DESC = {
  renderers: {
    ...
    mentalray: "A powerful, physically based renderer that allows for the creation of highly detailed and realistic images and animations. It has been used in many films and architectural visualization projects to create stunning visual effects.",
    opengl: "A widely-used, cross-platform graphics API that enables developers to create 2D and 3D graphics for a variety of applications. It has a long history of being used in video games and other interactive applications, and is still widely supported today.",
    directx: "A collection of APIs developed by Microsoft for creating and managing multimedia and gaming applications on Windows and Xbox platforms. It is widely used in the game industry, and has become the standard for developing games on the Windows platform.",
    luxcore: "LuxCore: An open-source, physically-based renderer that aims to provide a real-world workflow for creating photorealistic renders. It is known for its simple and intuitive user interface, and its ability to create highly detailed and realistic images.",
    infinid: "A 3D animation and modeling software that was widely used during the late 90s and early 2000s, known for its powerful modeling tools and its ability to create detailed animations. It was commonly used in the film and television industry for creating visual effects and animation.",
    zbrush: "A digital sculpting and painting software that is widely used in the game and film industries to create highly detailed 3D models. It allows artists to sculpt and paint highly detailed models in a way that is similar to traditional sculpting and painting.",
    blender: "An open-source, cross-platform 3D content creation software that is widely used in the animation, film, and game industries. It offers a wide range of features including modeling, animation, texturing, and compositing, and is known for its powerful and flexible workflow.",
    ...
    cryengine: "A game engine that is known for its advanced features, such as its powerful physics engine, real-time rendering capabilities and its ability to create large, open-world environments. It is widely used in the game industry for creating immersive and realistic games.",
    optix: "A high-performance, real-time rendering engine developed by NVIDIA. It is known for its ability to efficiently render large, complex scenes and its support for advanced features such as global illumination and deep learning-based denoising.",
    raylectron: "A plugin for SketchUp that allows users to create photorealistic renders of their SketchUp models. It is known for its simple and intuitive workflow, and its ability to produce high-quality renders in a short amount of time.",
    cinema4d: "A 3D animation, modeling and rendering software that is widely used in the film, television and motion graphics industry. It is known for its powerful modeling, animation, and rendering capabilities, as well as its intuitive and user-friendly interface.",
    houdini: "An animation software that is widely used in the film, television and game industry. It is known for its powerful procedural workflows and its ability to handle large and complex scenes, as well as its ability to create realistic simulations of physical phenomena such as fluid dynamics and particle effects.",
    cycles: "A rendering engine that is built into the Blender 3D software. It is a path-tracing renderer which simulates the way light behaves in the real world, creating highly detailed and realistic images. It is known for its ability to handle complex materials, lighting and motion blur, and it's capability to work with CPU and GPU.",
    eevee: "A real-time rendering engine built into Blender, that is optimized for real-time visualization and fast-paced workflow, allowing for interactive viewport playback and real-time lighting and shading. It is a physically based renderer and it's known for its ability to create photorealistic results in real-time.",
    octane: "A standalone GPU renderer that uses the NVIDIA CUDA technology to create highly detailed, photorealistic images and animations. It is known for its ability to handle large, complex scenes and its support for advanced features such as global illumination, motion blur and deep learning-based denoising.",
    unreal: "A game engine developed by Epic Games that is widely used in the game industry for creating immersive, high-fidelity games. It is known for its powerful real-time rendering capabilities, physics engine and its support for a wide range of platforms.",
    unity: "A cross-platform game engine that is widely used in the game industry for creating 2D, 3D, AR, and VR games and experiences. It is known for its powerful rendering capabilities, asset management tools and its support for a wide range of platforms, including mobile, desktop and console.",
  },
  photosites: {
    trendingpixiv: "\"Trending On Pixiv\" is a website that showcases popular artwork and illustrations shared on the Pixiv platform. It is a great way to discover new artists and see what styles and trends are currently popular among the community.",
    pixiv: "Pixiv is a website that allows users to share and discover artwork, illustrations, and comics. It is a popular platform for artists to share their work and get feedback, and it has a wide variety of styles and genres represented.",
    trendingartstation: "\"Trending On Artstation\" is a website that features popular artwork and illustrations shared on the Artstation platform. It is a great way to discover new artists and see what styles and trends are currently popular among the community.",
    artstation: "Artstation is a website that allows users to share and discover artwork, illustrations, and comics. It is a popular platform for artists to share their work and get feedback, and it has a wide variety of styles and genres represented.",
    cgsociety: "\"CGsociety\" is a website that is dedicated to computer graphics, digital art and animation. It is a platform where artists and professionals can share their work, collaborate, and learn from each other, it is also a community of over a million digital artists.",
    trendingcgsociety: "\"Trending On CGsociety\" is a website that showcases popular digital art and animation shared on the CGsociety platform. It is a great way to discover new artists and see what styles and trends are currently popular among the community.",
    unsplash: "\"Unsplash\" is a website that provides a library of high-resolution images that can be used for free for any purpose. It is a great resource for designers, photographers, and anyone looking for beautiful, high-quality images to use in their projects.",
    trendingunsplash: "\"Trending On Unsplash\" is a website that features popular images shared on the Unsplash platform. It is a great way to discover new photographers and see what styles and trends are currently popular among the community.",
    deviantart: "\"Deviantart\" is a website that allows users to share and discover digital art, traditional art, photography, and other forms of creativity. It is a platform for artists of all skill levels to share their work and get feedback, and it has a wide variety of styles and genres represented.",
    trendingdeviantart: "\"Trending On Deviantart\" is a website that showcases popular artwork and photographs shared on the Deviantart platform. It is a great way to discover new artists and see what styles and trends are currently popular among the community.",
    flickr: "\"Flickr\" is a website that is a platform for photography, it allows users to share, organize, and discover their photos. It is a community of photographers from around the world, and it has a wide variety of styles and genres represented.",
    trendingflickr: "\"Trending On Flickr\" is a website that features popular photographs shared on the Flickr platform. It is a great way to discover new photographers and see what styles and trends are currently popular among the community.",
    quixel: "\"Quixel\" is a website and software company that provides tools and services for creating and texturing 3D assets. It offers a range of products and services that help 3D artists to quickly and easily create high-quality 3D models, textures and materials.",
    trendingquixel: "\"Trending On Quixel\" is a website that showcases popular 3D models and textures shared on the Quixel platform. It is a great way to discover new artists and see what styles and trends are currently popular among the community.",
    googlemaps: "\"Google Maps\" is a web mapping service developed by Google. It offers satellite imagery, street maps, panoramic views, real-time traffic conditions, and route planning for traveling by foot, car, bicycle, or public transportation. It allows users to search for addresses, points of interest, and businesses and provides information on local businesses, including customer reviews and ratings.",
  },
  abstraction: {
    abstract: "A kaleidoscope of vibrant colors and shapes, swirling in a mesmerizing dance that defies the constraints of reality. A canvas for the mind, where imagination and creativity reign supreme.",
    americanrealism: "A gritty and raw depiction of everyday life, where the harsh realities of the world are laid bare for all to see. A mirror held up to society, reflecting the beauty and ugliness of humanity.",
    classicalrealism: "A masterful portrayal of the world in all its splendor, where every detail is captured with the precision and skill of a master artist. A timeless work of art that stands the test of time.",
    dreamlike: "A surreal and ethereal landscape, where the boundaries between reality and fantasy blur and merge. A dreamscape that captures the essence of the subconscious mind, revealing hidden truths and desires.",
    ethereal: "A realm of pure beauty and wonder, where the laws of physics and reality are but mere suggestions. A place where the impossible becomes possible, and the imagination is given free reign.",
    fantasyrealism: "A world where the fantastical and the realistic coexist in perfect harmony, where dragons fly alongside airplanes and magic and technology blend seamlessly. A place where the lines between fantasy and reality are blurred.",
    hyperrealistic: "A mirror image of reality, where every detail is captured in such stunning detail that it's hard to tell the difference between what is real and what is not. A world where the line between fantasy and reality disappears.",
    impossible: "A world where anything and everything is possible, where the laws of physics and reality are nothing more than suggestions. A place where the impossible becomes possible and the imagination is given free reign.",
    lucid: "A clear and crisp reality, where every detail is captured in sharp focus, and the mind is given the freedom to explore and discover. A world where the impossible becomes possible and the imagination is given free reign.",
    ...
    newrealism: "A new take on the world, where the boundaries between reality and fantasy blur and merge. A dreamscape that captures the essence of the subconscious mind, revealing hidden truths and desires.",
    otherworldly: "A realm beyond our understanding, where the laws of physics and reality are but mere suggestions. A place where the impossible becomes possible, and the imagination is given free reign.",
    ...
    realistic: "A world that closely mimics our own, where the laws of physics and reality are strictly followed and every detail is captured in stunning detail. A place where the line between fantasy and reality disappears.",
    socialistrealism: "A form of realism that emphasizes the role of the working class and the struggle for a socialist society. A reflection of the world, where the harsh realities of the world are laid bare for all to see.",
    surreal: "A world that defies the constraints of reality, where the boundaries between reality and fantasy blur and merge. A dreamscape that captures the essence of the subconscious mind, revealing hidden truths and desires.",
  },
  timeframes: {
    ...
    n2020s: "The 2020s is the current decade, it is defined by the photographic style that is being shaped by the ongoing digital revolution and the increasing use of smartphones and social media, resulting in an explosion of visual content and a democratization of photography. The photographs of this era are defined by their immediacy, and their ability to capture a moment in history.",
    n2010s: "The 2010s brought a new era of photographic style, with a focus on vibrant colors, sharp contrasts and digital manipulation that brought a fresh, modern feel to the art form. The photographs of this era were defined by a dynamic energy and a sense of movement, capturing the world in a way that was both fresh and exciting.",
    n2000s: "The photographic style of the 2000s was characterized by a minimalist aesthetic, with a focus on simplicity and clean lines. The photographs of this era were defined by their crisp, precise composition and a sense of stillness that created an almost meditative quality.",
    n1990s: "The 1990s brought a renewed focus on the documentary style of photography, with an emphasis on capturing real-life moments and emotions. The photographs of this era were defined by their raw, honest feel, capturing the world as it truly was with a sense of realism and authenticity.",
    n1980s: "The 1980s saw the rise of a new photographic style that was defined by its bold, experimental nature. The photographs of this era were defined by their use of vibrant colors, bold patterns, and a sense of playfulness that was both daring and exciting. They were a reflection of the fast-paced, dynamic world of the 1980s.",
    n1970s: "The 1970s brought a new era of photographic style, characterized by a focus on natural light and a sense of spontaneity. The photographs of this era were defined by their raw, unpolished feel and a sense of capturing the world in a moment of pure authenticity.",
    n1960s: "The photographic style of the 1960s was characterized by a focus on capturing the energy and excitement of the time, with an emphasis on capturing the movements of the counterculture. The photographs of this era were defined by their dynamic energy and a sense of capturing a moment in history.",
    n1950s: "The 1950s brought a renewed focus on the art of portrait photography, with an emphasis on capturing the essence of the subject. The photographs of this era were defined by their use of natural light and a sense of intimacy, capturing the subject's true nature and character.",
    n1940s: "The 1940s saw the rise of a new photographic style that was defined by its focus on capturing the reality of war and its aftermath. The photographs of this era were defined by their raw, honest feel and their ability to capture the true horror and devastation of war. They were a reflection of the world's darkest moments.",
    n1930s: "The 1930s brought a new era of photographic style, characterized by a focus on capturing the reality of everyday life. The photographs of this era were defined by their raw, honest feel and a sense of capturing the world in a moment of pure authenticity.",
    n1920s: "The photographic style of the 1920s was characterized by a focus on capturing the energy and excitement of the time, with an emphasis on capturing the movements of the counterculture. The photographs of this era were defined by their dynamic energy and a sense of capturing a moment in history.",
    n1910s: "Photography wasn't fully developed during the 1910s, however, the photography that existed during this period was defined by its focus on capturing the reality of everyday life. The photographs of this era were defined by their raw, honest feel and a sense of capturing the world in a moment of pure authenticity.",
    n1900s: "Photography wasn't fully developed during the 1900s, however, the photography that existed during this period was defined by its focus on capturing the reality of everyday life. The photographs of this era were defined by their raw, honest feel and a sense of capturing the world in a moment of pure authenticity.",
    n1850s: "Photography wasn't fully developed during the 1850s, however, the photography that existed during this period was defined by its focus on capturing the reality of everyday life. The photographs of this era were defined by their raw, honest feel and a sense of capturing the world in a moment of pure authenticity.",
    n1800s: "Photography wasn't fully developed during the 1800s, however, the photography that existed during this period was defined by its focus on capturing the reality of everyday life. The photographs of this era were defined by their raw, honest feel and a sense of capturing the world in a moment of pure authenticity.",
...
triangle: "A shape with three angles, three corners and three sides, a simple yet versatile shape that represents stability, balance and harmony, it's a basic building block of geometry, a fundamental shape that appears in countless forms in the natural world.", 
...
keplertriangle: "A right triangle in which the hypotenuse is also the side of a regular polygon, a shape that embodies the beauty of mathematical harmony and precision, its lines forming perfect geometric shapes.", 
...
incircleandexcirclesofatriangle: "The circles that are inscribed and circumscribed around a triangle, like an embrace and a boundary, a shape that reflects the relationship and balance between different elements.", 
...
export const INTANGIBLES_DESC = {
  ...
  symbols: {
    yinyang: "The ancient Chinese philosophical concept of dualism, where opposite forces are believed to be interconnected and interdependent in the natural world, such as dark and light, female and male, passive and active. It symbolizes the balance and harmony of the universe.",
  },
  zodiac: {
...
export const REFERENCEMEDIA_DESC = {
  animestudios: {
    animemadhousestudio: "Known for their visually stunning animation and attention to detail, Madhouse Studios creates anime that are both beautiful and intense. Their most famous work, \"Death Note\", is a psychological thriller that explores the blurred lines between good and evil.",
    animebonesstudio: "Studio Bones is known for their ability to bring complex stories to life through dynamic animation and character development. Their most famous work, \"Fullmetal Alchemist: Brotherhood\", is a masterful retelling of the original manga that delves deep into the human condition.",
    animekyotoanimationstudio: "Kyoto Animation Studio is renowned for their emotive and relatable stories, brought to life through stunning animation and heartwarming characters. Their most famous work, \"K-On!\", is a slice-of-life anime that captures the joys and struggles of youth with undeniable warmth and charm.",
    animewitstudio: "Wit Studio is known for their visually striking animation and masterful storytelling, creating anime that are both epic and thought-provoking. Their most famous work, \"Attack on Titan\", is a dystopian epic that explores the human condition in the face of seemingly insurmountable adversity.",
    animetoeianimationsstudio: "Toei Animation Studio is one of the oldest and most established anime studios in Japan, known for their iconic and enduring anime series such as \"Dragon Ball\" and \"Sailor Moon\". Their style is characterized by its dynamic action, colorful animation, and memorable characters.",
    animemappastudio: "MAPPA Studio is a relatively new but rapidly rising studio, known for their innovative and visually striking anime such as \"Yuri!!! on Ice\" and \"Jujutsu Kaisen\". Their style is characterized by its unique animation techniques and storytelling that pushes the boundaries of the genre.",
    animeghiblistudio: "Studio Ghibli is a legendary anime studio known for their heartwarming and visually stunning anime, such as \"Spirited Away\" and \"My Neighbor Totoro\". Their style is characterized by its masterful storytelling, detailed animation, and breathtaking landscapes that transport viewers to another world.",
    animesunrisestudio: "Sunrise Studio is known for their groundbreaking anime such as \"Mobile Suit Gundam\" and \"Cowboy Bebop\". Their style is characterized by its complex and thought-provoking storylines, cutting-edge animation, and memorable characters that shape the future of anime.",
    animea1picturesstudio: "A-1 Pictures is known for their versatile style that ranges from fantasy to action to romance and comedy, as seen in anime such as \"Sword Art Online\" and \"Your Lie in April\". Their animation is smooth and polished, with a special attention to fine details.",
    animeufotablestudio: "Ufotable is known for their visually spectacular anime, such as \"Fate/Stay Night\" and \"Demon Slayer: Kimetsu no Yaiba\". Their animation is fluid and dynamic, with breathtaking fight scenes and stunning landscapes. They also have a special attention to lighting and color.",
    animepierrotstudio: "Studio Pierrot is known for their long-running anime series and their iconic adaptations of famous manga series such as \"Naruto\" and \"Bleach\". Their animation is colorful, lively and engaging, with a special attention to movement and facial expressions.",
    animetriggerstudio: "Studio Trigger is known for their innovative and visually striking anime, such as \"Kill la Kill\" and \"Little Witch Academia\". Their animation is dynamic, creative and bold, with a special attention to creative storytelling and character development. They also have a special attention to action and movement.",
    animepaworksstudio: "Known for their visually stunning animation and attention to detail, P.A.Works creates anime that are both beautiful and emotionally engaging. Their most famous work, \"Nagi no Asukara\", is a coming-of-age story that explores the complexities of growing up and falling in love.",
    animejcstaffstudio: "J.C.Staff is known for their ability to bring complex stories to life through dynamic animation and character development. Their most famous work, \"Toradora!\", is a romantic comedy that explores the complexities of teenage love and friendship with heart and humor.",
    animebrainsbasestudio: "Brain's Base is renowned for their emotive and relatable stories, brought to life through stunning animation and heartwarming characters. Their most famous work, \"Bungo Stray Dogs\", is an action-packed anime that explores the power of literature and the human spirit.",
    animecloverworksstudio: "Cloverworks is known for their visually striking animation and masterful storytelling, creating anime that are both epic and thought-provoking. Their most famous work, \"Darling in the FranXX\", is a dystopian epic that explores the human condition in the face of seemingly insurmountable adversity.",
    animegainaxstudio: "Known for their visually stunning animation and attention to detail, GainAX creates anime that are both beautiful and intellectually stimulating. Their most famous work, \"Neon Genesis Evangelion\", is a psychological thriller that explores the blurred lines between good and evil.",
    animeproductionigstudio: "Production IG is known for their ability to bring complex stories to life through dynamic animation and character development. Their most famous work, \"Ghost in the Shell\", is a masterful retelling of the original manga that delves deep into the human condition.",
    animeshaftstudio: "Shaft is renowned for their emotive and relatable stories, brought to life through stunning animation and heartwarming characters. Their most famous work, \"Monogatari Series\", is a series of anime that captures the joys and struggles of youth with undeniable warmth and charm.",
    animewhitefoxstudio: "White Fox is known for their visually striking animation and masterful storytelling, creating anime that are both epic and thought-provoking. Their most famous work, \"Re:ZERO - Starting Life in Another World\", is a fantasy epic that explores the human condition in the face of seemingly insurmountable adversity.",
  },
  ...
  videogames: {
    ...
    worldofwarcraft: "A massively multiplayer online role-playing game (MMORPG) set in a fantasy world, where players can choose from a variety of races and classes to create a unique character and embark on epic quests and battles.",
    ...
    teamfortress2: "A class-based, team-oriented first-person shooter where players select from a variety of character classes, each with their own unique abilities, and work together to complete objectives and eliminate the enemy team.",
    warframe: "A fast-paced, co-operative third-person shooter where players control ancient warriors known as Warframes and battle through hordes of enemies to complete missions and uncover the mysteries of the universe.",
