...
export const PHYSICALMEDIUMS_DESC = {
  drawingtypes: {
    illustration: "illustration",
    drawing: "Drawing",
    doodle: "Doodle",
...
export const POSTPROCESSING_DESC = {
  postprocessing: {
    aliasing: "Aliasing",
    occlusion: "Occlusion",
    exposure: "Exposure",
...
export const GROUP_DESCRIPTIONS = {
  mediumsDrawing: "Mediums - Drawing",
  mediumsPencil: "Mediums - Pencil",
  mediumsPen: "Mediums - Pen",
  mediumsCrayon: "Mediums - Crayon",
  mediumsPaint: "Mediums - Paint",
  mediumsText: "Mediums - Text",
  mediumsPrint: "Mediums - Print",
  mediumsFabric: "Mediums - Fabric",
  mediumsPhotography: "Mediums - Photography",
  mediumsDigital: "Mediums - Digital",
  physicalmediums: "Mediums - Physical",

  cameraResolution: "Camera - Resolution",
  cameraPerspective: "Camera - Perspective",
  cameraLens: "Camera - Lens",
  cameraScene: "Camera - Scene",
  cameraFilms: "Camera - Films",
  cameraCompanies: "Camera - Companies",
  camerasettings: "Camera - Settings",
  cameraOther: "Camera - Other",
  postprocessing: "Post Processing",
  postprocessingmisc: "Post Processing - Misc",
  postprocessingreflections: "Post Processing - Reflections",
  lddLighting: "LDD - Lighting",
  ldddimensionality: "LDD - Dimensionality",

  materialsMetals: "Materials - Metals",
  materialsGemstones: "Materials - Gemstones",
  materialsWood: "Materials - Wood",
  materialsPlastic: "Materials - Plastic and Foams",
  materialsRubber: "Materials - Rubber",
  materialsWax: "Materials - Wax",
  materialsWater: "Materials - Water and Ice",
  materialsLiquid: "Materials - Liquids",
  materialsGas: "Materials - Gas",
  materialsOrganic: "Materials - Organics",
  materialsEnergy: "Materials - Energy",
  materialsFood: "Materials - Food",
  materialsPlantsFungi: "Materials - Plants and Fungi",
  materialsMusical: "Materials - Musical",
  materialsMiscellaneous: "Materials - Miscellaneous",
  materialsGel: "Materials - Gel",
  materialsGlue: "Materials - Glue",
  ...
  referenceAnimeStudio:
    ...
    artistAcademism: "Artist - Academism",
    artistArtsandCrafts: "Artist - Arts and Crafts",
    artistArtNouveau: "Artist - Art Nouveau",
    artistBaroque: "Artist - Baroque",
    artistBauhaus: "Artist - Bauhaus",
    artistBayArea: "Artist - Bay Area",
    artistContemporary: "Artist - Contemporary",
    artistEnvironmentalism: "Artist - Environmentalism",
    artistExpressionism: "Artist - Expressionism",
    artistFuturism: "Artist - Futurism",
    artistGothic: "Artist - Gothic",
    artistHeiseiEstheticism: "Artist - Heisei Estheticism",
    artistImpressionist: "Artist - Impressionist",
    artistInstallationArt: "Artist - Installation Art",
    artistLandscape: "Artist - Landscape",
    artistLowbrow: "Artist - Lowbrow",
    artistLuminism: "Artist - Luminism",
    artistNaturalism: "Artist - Naturalism",
    artistMannerism: "Artist - Mannerism",
    artistModernism: "Artist - Modernism",
    artistOrientalism: "Artist - Orientalism",
    artistPhotorealism: "Artist - Photorealism",
    artistPostImpressionist: "Artist - Post-Impressionist",
    artistPopArt: "Artist - Pop Art",
    artistPostmodern: "Artist - Postmodern",
    artistPsycadelic: "Artist - Psycadelic",
    artistRealist: "Artist - Realist",
    artistReligiousArt: "Artist - Religious Art",
    artistRenaissance: "Artist - Renaissance",
    artistRococo: "Artist - Rococo",
    artistRomantisism: "Artist - Romantisism",
    artistScienceFiction: "Artist - Science Fiction",
    artistSocialRealism: "Artist - Social Realism",
    artistStreetArt: "Artist - Street Art",
    artistSurrealist: "Artist - Surrealist",
    artistSymbolism: "Artist - Symbolism",
    artistHudsonRiver: "Artist - Hudson River",
    artistukiyoe: "Artist - Ukiyoe",
    artistVisionaryArt: "Artist - Visionary Art",
    artistartistartstation: "Artist - ArtStation",
    artistartistVideoGames: "Artist - Video Games",
    artistartistComicManga: "Artist - Comic/Manga",
    artistartistIllustrator: "Artist - Illustrator",
    artistnartistFilmDirector: "Artist - Film Director",
    nartistMusician: "Artist - Musician",
    nartistEtcher: "Artist - Etcher",
    nartistArchitect: "Artist - Architect",
    nartistAnimator: "Artist - Animator",
    nartistPhotography: "Artist - Photography",
    nartistSculpter: "Artist - Sculpter",
    nartistWriter: "Artist - Writer",
...
export const GROUP_TITLES = {
  ...
  materialsGemstones: "Materials - Gemstones",
  materialsWood: "Materials - Wood",
  materialsPlastic: "Materials - Plastic",
  materialsRubber: "Materials - Rubber",
  materialsWax: "Materials - Wax",
  materialsWater: "Materials - Water and Ice",
  materialsLiquid: "Materials - Liquids",
