      ...
      <div className='aspect'>
        <div className='bg1'>
          ...
          <div className='textAICenter'>
            ...
            <p>
             Midjourney, as a text to image model, uses text prompts to tell it what to generate. Prompts can be structured in many ways, and this page compares the effects of prompt structure and weighting. 
             For many effects, styles, artists etc, MidJourney doesn't know what "x in the style of y" looks like exactly, but looking through it's dataset, it knows how pictures in the style of y tend to look like, and their characteristics.
             By understanding how each style or keyword affects the image as a whole, we can create what we imagine

            </p>
            <p>
             Thanks to Tallath#0627 for running the prompts and research.
            </p>
